...
func main() {
	...
	flagSet.Bool("personal-access-token-basic-auth", false, "additionally allow HTTP Basic Authentication with a username/email and a user's personal access token instead of a password.")
